...
<body>
    ...
    <div class="container">
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;margin-top:55px;padding:0;" >
                            ...
                            <tr>
                                <td style="width: 25%;">
									<div class="dashboard-items" style="padding:20px;margin:auto;width:95%;display: flex; align-items: center; color: #912bbc">
										...
										<a href="doctors.php">
												<div class="btn-icon-back dashboard-icons" style="background-image: url('../img/dentist.png');cursor: pointer; background-size: contain; background-repeat: no-repeat; width: 50px; height: 50px; margin-left: 40px; left"></div>
										</a>
									</div>
								</td>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; flex; align-items: center; color: #912bbc"">
										...
										<a href="patient.php">
                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/patient.png'); cursor: pointer; background-size: contain; background-repeat: no-repeat; width: 50px; height: 50px; margin-left: 40px;"></div>
										</a>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; flex; align-items: center; color: #912bbc"">
										...
										<a href="schedule.php">
                                                 <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/bookings.png'); cursor: pointer; background-size: contain; background-repeat: no-repeat; width: 50px; height: 50px; margin-left: 40px;"></div>
										</a>
								  </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; flex; flex; align-items: center; color: #912bbc"">
										...
										<a href="appointment.php">
                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/sessions.png'); cursor: pointer; align-items: center; justify-content: center; background-size: contain; background-repeat: no-repeat; width: 50px; height: 50px; margin-left: 40px;"></div>
										</a>
								   </div>
                                </td>
