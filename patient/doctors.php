        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;  margin:0;padding:0;margin-top:55px; ">
                ...
                <td width="13%" >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Dentists</p>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       <a href="?action=session&id='.$docid.'&name='.$name.'"  class="non-style-link"><button  class="btn-primary-soft btn button-icon menu-icon-session-active"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Sessions</font></button></a>
                                        <style>
                                        .menu-icon-session-active:hover {
                                        background-color: #912bbc;
                                        }
                                        </style>
                                        </div>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Dentist Details</p><br><br>
                                </td>
                            </tr>
